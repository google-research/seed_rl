...
trainingInput:
  ...
  hyperparameters:
    ...
    - parameterName: entropy_cost
      type: DOUBLE
      minValue: 0.0009705614902108625
      maxValue: 0.0009705614902108625
      scaleType: UNIT_LOG_SCALE
    ...
    - parameterName: learning_rate
      type: DOUBLE
      minValue: 0.00022587896096859582
      maxValue: 0.00022587896096859582
      scaleType: UNIT_LOG_SCALE
    - parameterName: adam_epsilon
      type: DOUBLE
      minValue: 0.000000003125
      maxValue: 0.000000003125
      scaleType: UNIT_LOG_SCALE
EOF
